...
-- AddForeignKey
ALTER TABLE "doctors" ADD CONSTRAINT "doctors_officeId_fkey" FOREIGN KEY ("officeId") REFERENCES "offices"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "appointments" ADD CONSTRAINT "appointments_officeId_fkey" FOREIGN KEY ("officeId") REFERENCES "offices"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "consultations" ADD CONSTRAINT "consultations_clinicalHistoryId_fkey" FOREIGN KEY ("clinicalHistoryId") REFERENCES "clinical_histories"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "exams" ADD CONSTRAINT "exams_consultationId_fkey" FOREIGN KEY ("consultationId") REFERENCES "consultations"("id") ON DELETE CASCADE ON UPDATE CASCADE;
