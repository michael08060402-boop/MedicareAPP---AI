...
export default function SettingsForm({ name, email }: { name: string; email: string }) {
  // Profile
  ...
  return (
    <>
      {/* Profile */}
      <form onSubmit={handleProfile} className="bg-white rounded-2xl border border-gray-100 p-6 mb-5">
        <div className="flex items-center gap-2 mb-5">
          <User className="w-4 h-4 text-blue-400" />
          <h3 className="text-sm font-bold text-gray-700">Mi perfil</h3>
        </div>
        <div className="flex items-center gap-4 mb-5">
          <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-blue-100 to-cyan-100 flex items-center justify-center text-blue-600 text-xl font-bold">
            {pName.charAt(0) || "P"}
          </div>
          <div>
