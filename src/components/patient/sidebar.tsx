...
import {
  Home, CalendarDays, CalendarPlus, ClipboardList,
  FileText, Settings, ChevronRight, MessageCircle, Bot, X,
} from "lucide-react";
...
const NAV = [
  {
    label: "Principal",
    items: [
      { icon: Home, label: "Inicio", href: "/patient" },
      { icon: CalendarDays, label: "Mis citas", href: "/patient/appointments" },
      { icon: CalendarPlus, label: "Agendar cita", href: "/patient/book" },
    ],
  },
  {
    label: "Asistente",
    items: [
      { icon: Bot, label: "Asistente IA", href: "/patient/assistant" },
    ],
  },
  {
    label: "Historial",
    items: [
      { icon: ClipboardList, label: "Mi historial", href: "/patient/history" },
      { icon: FileText, label: "Mis recetas", href: "/patient/prescriptions" },
    ],
  },
  {
    label: "Cuenta",
    items: [
      ...
      { icon: MessageCircle, label: "Soporte", href: "/patient/support" },
    ],
  },
];
